...
<c:set var="page_write" value="질문글 작성"/>
...
<c:set var="str_regdate" value="작성일"/>
...
<c:set var="btn_write" value="작성하기"/>
<c:set var="btn_cancel" value="작성취소"/>
<c:set var="btn_list" value="목록으로"/>
<c:set var="btn_mod" value="수정하기"/>
<c:set var="btn_del" value="삭제하기"/>
